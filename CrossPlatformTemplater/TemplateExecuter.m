...
+ (DictValue *)buildConstants {
    ...
    [network set:[TrueValue getInstance] forKey:@"IsReachable"];
    [network set:[[NSProcessInfo processInfo] hostName] forKey:@"Hostname"];
...
#endif
#ifdef FOR_APP
    [app set:[[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"www"] forKey:@"WWWDir"];
#endif
