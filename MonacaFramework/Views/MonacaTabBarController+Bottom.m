...
- (void)applyBottomToolbar:(NSDictionary *)uidict {
    ...
    if (nil != components) {
        ...
        self.leftBottomToolbarContainers = [self createContainers:components];
    ...
    if (nil != components) {
        ...
        items = [NSMutableArray array];
        self.centerBottomToolbarContainers = [self createContainers:components];
    ...
    if (nil != components) {
        items = [NSMutableArray array];
        self.rightBottomToolbarContainers = [self createContainers:components];
